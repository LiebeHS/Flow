...
- `js/components/config.js` hardcodes `API_URL` as an absolute LAN IP (`http://10.130.10.200:3000/api`), not `localhost` — update this if the backend host changes; there's no env-based config for the frontend.
